...
# X contains features (input data).
# y contains the label (target value to predict).
...
# Testing on unseen data helps check how well the model generalizes.
...
# Lower MAE is better because prediction errors are smaller.
# R² closer to 1 is better because the model explains more variation in data.