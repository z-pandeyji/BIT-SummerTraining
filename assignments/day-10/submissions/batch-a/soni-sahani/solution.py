...
# Question 1: Line Chart(Create a line chart of months and monthly_sales.)
# Title: Monthly Sales
# X-axis label: Month
# Y-axis label: Sales
...
plt.figure(figsize=(8, 5))
plt.plot(months, python_students, marker="o", color="blue", label="Python Students")
plt.plot(months, ai_students, marker="o", color="green", label="AI Students")
