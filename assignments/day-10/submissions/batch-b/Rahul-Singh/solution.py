...
plt.plot(months, ai_students, marker='s', label="AI")
...
# -----------------------------
# A bar chart is the best chart for comparing courses because
# it clearly shows the difference in the number of students
# enrolled in each course, making comparisons easy.