...
plt.grid(True)
plt.legend()
plt.savefig('monthly_sales_with_grid.png')
plt.close()
...
plt.tight_layout()
plt.savefig('students_by_course_readable.png')
plt.close()

# Question 8: Reflection Comment
# Bar chart is best for comparing courses because it clearly shows the magnitude difference between categories,
# making it easy to compare values side-by-side. Pie charts show proportions but are harder to compare exact values.
